...
var getCategorizeFeedback = function(){
	...
	if ((trial_id == 'practice_trial') && (jsPsych.data.getDataByTrialIndex(curr_trial).stop_signal_condition == 'go')){
		if (jsPsych.data.getDataByTrialIndex(curr_trial).key_press == jsPsych.data.getDataByTrialIndex(curr_trial).correct_response){
			...
			return '<div class = upperbox><div class = center-text><font size = 20>Correct!</font></div></div>' + getPromptTextList()
			...
			return '<div class = upperbox><div class = center-text><font size = 20>Incorrect</font></div></div>' + getPromptTextList()
	
		} else if (jsPsych.data.getDataByTrialIndex(curr_trial).key_press == -1){
			
			
			return '<div class = upperbox><div class = center-text><font size = 20>Respond Faster!</font></div></div>' + getPromptTextList()
		...
		if (jsPsych.data.getDataByTrialIndex(curr_trial).rt == -1){
			...
			return '<div class = upperbox><div class = center-text><font size = 20>There was a star.</font></div></div>' + getPromptTextList()
		}
...
var practice_thresh = 4 // 4 blocks of 24 trials
...
stop_signal_single_task_network__practice_experiment.push(motor_setup_block) //exp_input
