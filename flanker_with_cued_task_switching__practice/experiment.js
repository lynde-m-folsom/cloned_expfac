...
var preFileType =
  '<img class = center src="/static/experiments/flanker_with_cued_task_switching__practice/images/';
...
var pathSource =
  "/static/experiments/flanker_with_cued_task_switching__practice/images/";
...
var refreshNode = {
  ...
  loop_function: function (data) {
    ...
    if (accuracy < accuracy_thresh) {
      refresh_feedback_text +=
        "<p class = block-text>Remember:" + getPromptTaskList();
...
flanker_with_cued_task_switching__practice_experiment.push(
