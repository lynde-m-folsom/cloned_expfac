...
var makeTaskSwitches = function (numTrials) {
  task_switch_arr = [
    "td_same_tstay_cswitch",
    "td_same_tstay_cstay",
    "td_same_tswitch_cswitch",
    "td_diff_tstay_cswitch",
    "td_diff_tstay_cstay",
    "td_diff_tswitch_cswitch",
    "td_na_tstay_cswitch",
    "td_na_tstay_cstay",
    "td_na_tswitch_cswitch",
  ];
...
var createTrialTypes = function (task_conditions) {
  ...
  shape_matching_trial_type_list =
    makeShapeMatchingDesignTrialTypes(task_conditions);
...
function getRefreshFeedback() {
  if (getRefreshTrialID() == "instructions") {
    return (
      ...
      "the shapes are in.</p>" +
      "<p class = block-text>When in the top two quadrants, please judge whether the two shapes are <i>the same</i>. Press the <i>" +
      getPossibleResponses()[0][0] +
      "  </i>if they are <i>the same</i>, and the <i>" +
      getPossibleResponses()[1][0] +
      "  </i>if they are <i>different</i>.</p>" +
      "<p class = block-text>When in the bottom two quadrants, please judge whether the two shapes are <i>different.</i>" +
      " Press the <i>" +
      getPossibleResponses()[0][0] +
      " </i> if they are <i> different</i>, and the <i>" +
      getPossibleResponses()[1][0] +
      ...
      "<p class = block-text>During practice, you will receive a reminder of the rules. <i>This reminder will be taken out when you are being scanned.</i> Press enter to start.</p>"
    );
  } else {
    return (
...
var pathDesignSource =
  "/static/experiments/shape_matching_with_spatial_task_switching__practice/designs/";
...
var getPromptTextList = function () {
  return (
    '<ul style="text-align:left; font-size: 32px; line-height:1.2;">' +
...
var getPromptText = function () {
  return (
    ...
    '<p class = center-block-text style = "font-size:20px; line-height:80%%;">Top 2 quadrants: Answer if the green and white shapes are the same </p>' +
    '<p class = center-block-text style = "font-size:20px; line-height:80%%;">Same: ' +
    getPossibleResponses()[0][0] +
    " | Different: " +
    getPossibleResponses()[1][0] +
    "</p>" +
    "<p>&nbsp</p>" +
    "<p>&nbsp</p>" +
    '<p class = center-block-text style = "font-size:20px; line-height:80%%;">Bottom 2 quadrants: Answer if the green and white shapes are different </p>' +
    '<p class = center-block-text style = "font-size:20px; line-height:80%%;">Different: ' +
    getPossibleResponses()[0][0] +
    " | Same: " +
    getPossibleResponses()[1][0] +
    "</p>" +
