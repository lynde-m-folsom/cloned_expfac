...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'n_back_with_spatial_task_switching__practice'})
}
...
function createNBackConditionsArray(length) {
    ...
    var n_back_conditions = Array(numMatch).fill('match').concat(Array(numMismatch).fill('mismatch'));
...
var createTrialTypes = function(task_switches, trial_lens){ //spatial task
...
function getRefreshFeedback(){
	if (getRefreshTrialID()=='instructions'){
		...
		'<p class = block-text>Press the '+getPossibleResponses()[0][0]+' if the current letter matches the letter 1 or 2 trials ago, and the '+getPossibleResponses()[1][0]+' if they mismatch.</p> '+
...
var pathSource = "/static/experiments/n_back_with_spatial_task_switching__practice/images/"
var pathDesignSource = "/static/experiments/n_back_with_spatial_task_switching__practice/designs/"

var fileTypePNG = ".png'></img>"
var preFileType = "<img class = center src='/static/experiments/n_back_with_spatial_task_switching__practice/images/"
...
var getPromptTextList = function(){
	return'<ul style="text-align:left;">'+
						...
						'<li>If they match, press the '+getPossibleResponses()[0][0]+'</li>' +
					    '<li>If they mismatch, press the '+getPossibleResponses()[1][0]+'</li>' +
					'</ul>'
}
...
var getPromptText = function(){
	return'<div class = prompt_box>'+
					...
					'<p class = center-block-text style = "font-size:16px; line-height:80%%;">If they match, press the '+getPossibleResponses()[0][0]+'</p>' +
					'<p class = center-block-text style = "font-size:16px; line-height:80%%;">If they mismatch, press the '+getPossibleResponses()[1][0]+'</p>' +
				'</div>'
...
n_back_with_spatial_task_switching__practice_experiment.push(refresh_feedback_block)
