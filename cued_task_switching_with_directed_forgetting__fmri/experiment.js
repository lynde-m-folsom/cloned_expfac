...
/* ************************************ */
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'cued_task_switching_with_directed_forgetting__fmri'})
}
...
var preFileType = "<img class = center src='/static/experiments/cued_task_switching_with_directed_forgetting__fmri/images/"
...
var pathSource = "/static/experiments/cued_task_switching_with_directed_forgetting__fmri/images/"
var images = []
...
cued_task_switching_with_directed_forgetting__fmri_experiment.push(design_setup_block); //exp_input
cued_task_switching_with_directed_forgetting__fmri_experiment.push(motor_setup_block); //exp_input

test_keys(cued_task_switching_with_directed_forgetting__fmri_experiment, [89, 71])

cued_task_switching_with_directed_forgetting__fmri_experiment.push(practiceNode);
cued_task_switching_with_directed_forgetting__fmri_experiment.push(feedback_block);

cni_bore_setup(cued_task_switching_with_directed_forgetting__fmri_experiment)
cued_task_switching_with_directed_forgetting__fmri_experiment.push(start_test_block);
cued_task_switching_with_directed_forgetting__fmri_experiment.push(testNode);
cued_task_switching_with_directed_forgetting__fmri_experiment.push(feedback_block);

cued_task_switching_with_directed_forgetting__fmri_experiment.push(post_task_block);
