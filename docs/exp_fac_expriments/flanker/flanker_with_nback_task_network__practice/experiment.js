...
function getPracticeFeedbackTiming() {
  return practice_feedback_timing;
}

function getPracticeResponseEnds() {
...
var pathDesignSource =
  '/static/experiments/flanker_with_nback__practice/designs/';
var pathSource = '/static/experiments/flanker_with_nback__practice/images/';
var fileTypePNG = ".png'></img>";
var preFileType =
  "<img class = center src='/static/experiments/flanker_with_nback__practice/images/";
...
/* ************************************ */
// init array
var flanker_with_nback__practice_experiment = [];

flanker_with_nback__practice_experiment.push(motor_setup_block); //exp_input

//out of scanner practice
flanker_with_nback__practice_experiment.push(intro_block);
flanker_with_nback__practice_experiment.push(practiceNode1);
flanker_with_nback__practice_experiment.push(practiceNode2);
flanker_with_nback__practice_experiment.push(practice_feedback_block);
flanker_with_nback__practice_experiment.push(practice_end_block);
