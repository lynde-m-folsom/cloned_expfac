...
function getResponseKeys() {
    ...
    return {key: [[37,39],[39,37]], key_name: [["index finger","middle finger"],["middle finger","index finger"]]}
  } else if (getMotorPerm()==3) {
    return {key: [[39,37],[39,37]], key_name: [["middle finger","index finger"],["middle finger","index finger"]]}
  }
}
...
var practiceNode = {
  ...
  loop_function: function(data) {
    ...
    if (accuracy > accuracy_thresh){
      ...
      practice_feedback_text +=
          '</p><p class = instruct-text>We are going to try practice again to see if you can achieve higher accuracy.  Remember: <br>' + getPromptTaskList() 
...
cued_task_switching_single_task_network__practice_experiment.push(motor_setup_block); //exp_input
