...
function getTaskList() {
  return (
    "<ul><li><strong><i>Parity</i> or <i>Odd-Even</i>: Press your " +
    getResponseKeys().key_name[1][0] +
    " key if even and your " +
    getResponseKeys().key_name[1][1] +
    " key if odd." +
    "</li><li><i>Magnitude</i> or <i>High-Low</i>: Press your " +
    getResponseKeys().key_name[0][0] +
    " key if the number is greater than 5 and your " +
...
function getPromptTaskList() {
  return (
    '<ul style="text-align:left"><li><i>Parity</i> or <i>Odd-Even</i>: ' +
    getResponseKeys().key_name[1][0] +
    " if even and " +
    getResponseKeys().key_name[1][1] +
    " if odd." +
    "</li><li><i>Magnitude</i> or <i>High-Low</i>: " +
    getResponseKeys().key_name[0][0] +
    " if >5 and " +
    getResponseKeys().key_name[0][1] +
    " if <5.</li></ul>"
...
function addID() {
  jsPsych.data.addDataToLastTrial({
    exp_id: "cued_task_switching_single_task_network__fmri",
  });
}
...
var getCue = function () {
  var cue_html =
    '<div class = upperbox><div class = "center-text" >' +
    curr_cue +
    "</div></div>" +
...
var preFileType =
  "<img class = center src='/static/experiments/cued_task_switching_single_task_network__fmri/images/";
...
var pathSource =
  "/static/experiments/cued_task_switching_single_task_network__fmri/images/";
var pathDesignSource =
  "/static/experiments/cued_task_switching_single_task_network__fmri/designs/"; //ADDED FOR fMRI SEQUENCES
...
var design_setup_block = {
  ...
  questions: [["<p class = center-block-text>Design permutation (0-4):</p>"]],
...
var testNode0 = {
  ...
  loop_function: function (data) {
    ...
    feedback_text =
      "<br><p class = instruct-text>Please take this time to read your feedback and to take a short break!";
    feedback_text +=
      "</p><p class = instruct-text>You have completed: " +
      testCount +
      " out of " +
      numTestBlocks +
      " blocks of trials.";
...
cued_task_switching_single_task_network__fmri_experiment.push(
  design_setup_block
); //exp_input
cued_task_switching_single_task_network__fmri_experiment.push(
  motor_setup_block
...
test_keys(
  cued_task_switching_single_task_network__fmri_experiment,
  response_keys.key[0]
);
